...
function(check_compiler_support_ie_flags ie)
    ...
    CHECK_CXX_COMPILER_FLAG("${flags}" KTEST_SUPPORT_${ie})
    message(STATUS "Checking compiler support ${ie} flags - Done")
    message(STATUS "set KTEST_SUPPORT_${ie} = ${KTEST_SUPPORT_${ie}}")
    if (${KTEST_SUPPORT_${ie}})
        set(KTEST_FLAGS_${ie} ${flags} PARENT_SCOPE)
        message(STATUS "set KTEST_FLAGS_${ie} = ${flags}")
    endif ()
    message("")
endfunction()
