/**
 * @file       set_intersection.test.cpp
 * @brief
 * @date       2021-06-18
 * @author     Peter
 * @copyright
...
KERBAL_TEMPLATE_TEST_CASE(test_set_intersection, "test set_intersection")
{
	...
	for (std::size_t i = 0; i < kerbal::container::size(test_cases); ++i) {
		...
		kerbal::algorithm::set_intersection(
...
KERBAL_TEMPLATE_TEST_CASE_INST(test_set_intersection, "test set_intersection (Ctg)", kerbal::container::vector<int>);
KERBAL_TEMPLATE_TEST_CASE_INST(test_set_intersection, "test set_intersection (Ras)", std::deque<int>);
KERBAL_TEMPLATE_TEST_CASE_INST(test_set_intersection, "test set_intersection (Bid)", kerbal::container::list<int>);
