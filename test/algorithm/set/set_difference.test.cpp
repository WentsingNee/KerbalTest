...
KERBAL_TEMPLATE_TEST_CASE(test_set_difference, "test set_difference")
{
	...
	for (std::size_t i = 0; i < kerbal::container::size(test_cases); ++i) {
		...
		kerbal::algorithm::set_difference(
...
KERBAL_TEMPLATE_TEST_CASE_INST(test_set_difference, "test set_difference (Ctg)", kerbal::container::vector<int>);
KERBAL_TEMPLATE_TEST_CASE_INST(test_set_difference, "test set_difference (Ras)", std::deque<int>);
KERBAL_TEMPLATE_TEST_CASE_INST(test_set_difference, "test set_difference (Bid)", kerbal::container::list<int>);
