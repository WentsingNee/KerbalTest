/**
 * @file       set_symmetric_difference.test.cpp
 * @brief
 * @date       2021-06-18
 * @author     Peter
 * @copyright
...
KERBAL_TEMPLATE_TEST_CASE(test_set_symmetric_difference, "test set_symmetric_difference")
{
	...
	for (std::size_t i = 0; i < kerbal::container::size(test_cases); ++i) {
		...
		kerbal::algorithm::set_symmetric_difference(
...
KERBAL_TEMPLATE_TEST_CASE_INST(test_set_symmetric_difference, "test set_symmetric_difference (Ctg)", kerbal::container::vector<int>);
KERBAL_TEMPLATE_TEST_CASE_INST(test_set_symmetric_difference, "test set_symmetric_difference (Ras)", std::deque<int>);
KERBAL_TEMPLATE_TEST_CASE_INST(test_set_symmetric_difference, "test set_symmetric_difference (Bid)", kerbal::container::list<int>);
KERBAL_TEMPLATE_TEST_CASE_INST(test_set_symmetric_difference, "test set_symmetric_difference (Fwd)", kerbal::container::forward_list<int>);
