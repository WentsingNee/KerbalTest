...
template <typename T>
KERBAL_TEMPLATE_TEST_CASE(test_numeric_countr_zero, "test numeric::countr_zero")
{
...
KERBAL_TEMPLATE_TEST_CASE_INST(test_numeric_countr_zero, "test numeric::countr_zero", unsigned char)
KERBAL_TEMPLATE_TEST_CASE_INST(test_numeric_countr_zero, "test numeric::countr_zero", unsigned short)
KERBAL_TEMPLATE_TEST_CASE_INST(test_numeric_countr_zero, "test numeric::countr_zero", unsigned int)
KERBAL_TEMPLATE_TEST_CASE_INST(test_numeric_countr_zero, "test numeric::countr_zero", unsigned long)
KERBAL_TEMPLATE_TEST_CASE_INST(test_numeric_countr_zero, "test numeric::countr_zero", unsigned long long)
