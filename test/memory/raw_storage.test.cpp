...
KERBAL_TEST_CASE(test_raw_storage_non_move_assignable, "test rawst non move_assignable")
{
	using namespace kerbal::type_traits;

#define TRY_TEST_CHECK_WEAK_(Ans, Type) TRY_TEST_CHECK_WEAK(Ans, kerbal::type_traits::try_test_is_move_assignable<kerbal::memory::raw_storage<Type> >::value)
