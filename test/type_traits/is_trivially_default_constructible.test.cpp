...
KERBAL_TEST_CASE(test_has_is_trivially_default_constructible_support, "test has is_trivially_default_constructible support")
{
	...
	std::puts("kerbal::type_traits::is_trivially_default_constructible is supported!");
#else
	std::puts("kerbal::type_traits::is_trivially_default_constructible is not supported!");
#endif
